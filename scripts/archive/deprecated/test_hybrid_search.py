...
async def test_search_queries():
    ...
    test_queries = [
        {
            "query": "Sanierung Fenster",
            "description": "Search for window renovation information"
        },
        {
            "query": "Heizung Installation",
            "description": "Search for heating installation details"
        },
        {
            "query": "Elektro Raumbuch",
            "description": "Search for electrical room book"
        },
        {
            "query": "Finanzierung",
            "description": "Search for financing information"
        },
        {
            "query": "Vertrag",
    ...
    for idx, test_case in enumerate(test_queries, start=1):
        ...
        try:
            ...
            print(f"      Diversity score: {hybrid_results['search_metadata']['diversity']['overlap_ratio']:.2%}")
