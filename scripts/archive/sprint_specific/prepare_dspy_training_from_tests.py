    ...
    # ============================================================================
    {
        ...
        "entities": [
            ...
            {"name": "Geghard Monastery", "type": "LOCATION", "description": "Medieval monastery"},
            {
                "name": "Havuts Tar",
                "type": "LOCATION",
                "description": "11th-13th century monastery",
            },
    ...
    # ============================================================================
    {
        ...
        "entities": [
            {"name": "Christina Mejia", "type": "PERSON", "description": "Mother of victim"},
            {
                "name": "Jessica Mejia",
                "type": "PERSON",
                "description": "Crash victim, 20 years old",
            },
            ...
            {"name": "Cara Smith", "type": "PERSON", "description": "Sheriff's spokeswoman"},
            {
                "name": "Denis Savard",
                "type": "PERSON",
                "description": "Former Chicago Blackhawks player",
            },
        ...
        "relations": [
            {
                "source": "Christina Mejia",
                "target": "Jessica Mejia",
                "type": "MOTHER_OF",
                "strength": 10,
            },
            {
                "source": "Nicholas Sord",
                "target": "Jessica Mejia",
                "type": "EX_BOYFRIEND_OF",
                "strength": 10,
            },
            {
                "source": "Nicholas Sord",
            ...
            {
                "source": "Jessica Mejia",
                "target": "December 31, 2009",
                "type": "DIED_ON",
                "strength": 10,
            },
            {
                "source": "Christina Mejia",
                "target": "Cook County Sheriff's Office",
                "type": "SUED",
                "strength": 9,
            },
            {
                "source": "Don Perry",
                "target": "Christina Mejia",
                "type": "ATTORNEY_FOR",
                "strength": 9,
            },
            {
...
Both frameworks support GPU acceleration via NVIDIA CUDA.""",
        "entities": [
            ...
            {"name": "C++", "type": "LANGUAGE", "description": "Programming language"},
            {
                "name": "TensorFlow 2.0",
                "type": "SOFTWARE",
                "description": "Major TensorFlow version",
            },
...
introduced in the "Attention Is All You Need" paper by Vaswani et al. in 2017.""",
        "entities": [
            ...
            },
            {
                "name": "Vaswani et al.",
                "type": "AUTHOR",
                "description": "Transformer paper authors",
            },
