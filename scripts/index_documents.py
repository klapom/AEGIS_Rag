...
async def main():
    ...
    print("    Embedding: bge-m3 (1024D)")
    print("    Chunking: 600 tokens, adaptive, 150 overlap")
    ...
    print("   This will load, chunk, embed, and index all documents.")
    ...
    print("   - Embedding model: bge-m3 (1024D)")
    print("   - Chunking: 600 tokens, adaptive, 150 overlap")
    print("\nNote: This script indexes to Qdrant only.")
    print("      For Neo4j/LightRAG indexing, use index_three_specific_docs.py")
