...
Sprint 56: Migrated from src/components/llm_proxy/cost_tracker.py
Original Sprint 23 - Feature 23.4: Multi-Cloud LLM Execution
Related ADR: ADR-033
...
def get_cost_tracker() -> CostTracker:
    ...
    Example:
        >>> from src.domains.llm_integration.cost import get_cost_tracker
