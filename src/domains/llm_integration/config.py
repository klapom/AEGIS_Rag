"""
Configuration management for LLM integration domain.

Sprint 56: Migrated from src/components/llm_proxy/config.py
Original Sprint Context: Sprint 23 (2025-11-11+) - Feature 23.4
