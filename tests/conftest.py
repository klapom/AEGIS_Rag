...
# NOTE: lightrag_instance fixture removed in Sprint 128 - LightRAG removal
# Tests that need graph operations should use neo4j_client fixture or mock Neo4jClient directly
