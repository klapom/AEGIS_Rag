...
class TestLightRAGWrapperSprint16:
    ...
    @pytest.mark.skip(
        reason="Sprint 55: _chunk_text_with_metadata removed in lightrag package refactoring"
    )
    ...
    @pytest.mark.skip(
        reason="Sprint 55: _store_chunks_and_provenance_in_neo4j removed in lightrag package refactoring"
    )
    @pytest.mark.asyncio
