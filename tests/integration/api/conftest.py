...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "requires_ollama: mark test as requiring Ollama LLM service")
    config.addinivalue_line("markers", "requires_neo4j: mark test as requiring Neo4j database")
    config.addinivalue_line("markers", "requires_redis: mark test as requiring Redis service")
    config.addinivalue_line("markers", "requires_qdrant: mark test as requiring Qdrant vector DB")
