...
def preview_mega_pdf() -> Path:
    ...
    pdf_path = (
        Path(__file__).parent.parent.parent / "data" / "sample_documents" / "preview_mega.pdf"
    )
...
class TestScriptIntegration:
    ...
    async def test_e2e_script_cli_execution(self, preview_mega_pdf, tmp_path):
        ...
        script_path = (
            ...
            / "scripts"
            / "generate_document_ingestion_report.py"
        )
        ...
        try:
            ...
            report_path = (
                Path(__file__).parent.parent.parent / "data" / "docling_report_sprint23.html"
            )
