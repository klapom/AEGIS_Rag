    ...
    samples = [
        {
            ...
            "entities": ["force majeure clause", "contract provision", "contractual obligations", "performance"],
            "relations": [
                {"subject": "force majeure clause", "predicate": "is_a", "object": "contract provision"},
                {"subject": "force majeure clause", "predicate": "relieves", "object": "contractual obligations"}
            ]
        },
        {
            ...
            "entities": ["indemnification clauses", "compensation", "losses", "damages", "liabilities", "breaches"],
            "relations": [
                {"subject": "indemnification clauses", "predicate": "require", "object": "compensation"}
            ]
        },
        {
            ...
            "entities": ["termination conditions", "breach of contract", "mutual agreement", "early termination"],
            "relations": [
                {"subject": "termination conditions", "predicate": "include", "object": "breach of contract"}
            ]
        },
        {
            ...
            "entities": ["representation", "statement of fact", "warranty", "promise", "contract terms"],
            "relations": [
        ...
        },
        {
            ...
            "entities": ["confidentiality obligations", "secret information", "disclosure", "third parties"],
            "relations": [
                {"subject": "confidentiality obligations", "predicate": "restrict", "object": "disclosure"}
            ]
        },
        {
            ...
            "relations": [
                {"subject": "material breach", "predicate": "undermines", "object": "contract terms"}
            ]
        },
        {
        ...
        },
        {
            ...
            "entities": ["statute of limitations", "time period", "legal proceedings", "jurisdiction"],
            "relations": [
        ...
        },
        {
            ...
            "entities": ["arbitration", "dispute resolution", "arbitrator", "litigation", "court process", "judge"],
            "relations": [
        ...
        },
        {
            ...
            "entities": ["IP indemnification", "patents", "copyrights", "trademarks", "trade secrets"],
            "relations": [
        ...
        },
        {
            ...
            "relations": [
                {"subject": "severability clause", "predicate": "ensures", "object": "contract provision"}
            ]
        },
        {
            ...
            "entities": ["consideration", "value", "contract", "legally binding", "money", "services"],
            "relations": [
        ...
        },
        {
            ...
            "entities": ["fraud", "false representation", "material fact", "intent to deceive", "damages"],
            "relations": [
        ...
        },
        {
            ...
            "entities": ["parol evidence rule", "oral statements", "written statements", "written contract"],
            "relations": [
                {"subject": "parol evidence rule", "predicate": "prevents", "object": "oral statements"}
            ]
        },
    ]
    ...
    samples = [
        {
            ...
            "entities": ["Type 2 diabetes", "increased thirst", "frequent urination", "fatigue", "blurred vision"],
            "relations": [
                {"subject": "Type 2 diabetes", "predicate": "has_symptom", "object": "increased thirst"},
        ...
        },
        {
            ...
            "entities": ["ACE inhibitors", "angiotensin-converting enzyme", "angiotensin I", "angiotensin II", "vasodilation", "blood pressure"],
            "relations": [
                {"subject": "ACE inhibitors", "predicate": "block", "object": "angiotensin-converting enzyme"},
        ...
        },
        {
            ...
            "entities": ["wound healing", "hemostasis", "inflammation", "proliferation", "remodeling"],
            "relations": [
        ...
        },
        {
            ...
            "entities": ["heart failure", "blood", "fluid accumulation", "cardiac output", "compensatory mechanisms"],
            "relations": [
        ...
        },
        {
            ...
            "entities": ["NSAID", "contraindications", "peptic ulcer disease", "renal impairment", "heart failure"],
            "relations": [
                {"subject": "NSAID", "predicate": "contraindicated_in", "object": "peptic ulcer disease"}
            ]
        },
        {
            ...
            "relations": [
                {"subject": "HbA1c", "predicate": "measures", "object": "blood glucose"}
            ]
        },
        {
        ...
        },
        {
            ...
            "entities": ["systolic pressure", "diastolic pressure", "arterial pressure", "heart contraction"],
            "relations": [
                {"subject": "systolic pressure", "predicate": "measures_during", "object": "heart contraction"}
            ]
        },
        {
            ...
            "entities": ["corticosteroid", "side effects", "weight gain", "osteoporosis", "adrenal suppression"],
            "relations": [
...
def technical_domain_training_dataset(tmp_path: Path) -> Path:
    ...
    samples = [
        ...
        },
        {
            ...
            "entities": ["CAP theorem", "distributed systems", "Consistency", "Availability", "Partition tolerance"],
            "relations": [
                {"subject": "CAP theorem", "predicate": "applies_to", "object": "distributed systems"}
            ]
        },
        {
            ...
            "entities": ["container orchestration", "deployment", "scaling", "Kubernetes", "Docker Swarm", "ECS"],
            "relations": [
                {"subject": "container orchestration", "predicate": "automates", "object": "deployment"},
        ...
        },
        {
            ...
            "entities": ["SQL databases", "ACID properties", "NoSQL databases", "horizontal scaling", "data models"],
            "relations": [
                {"subject": "SQL databases", "predicate": "has", "object": "ACID properties"},
                {"subject": "NoSQL databases", "predicate": "offers", "object": "horizontal scaling"}
            ]
        },
        {
        ...
        },
        {
            ...
            "entities": ["SOLID principles", "Single Responsibility", "Open-Closed", "Liskov Substitution", "Interface Segregation", "Dependency Inversion"],
            "relations": [
                {"subject": "SOLID principles", "predicate": "includes", "object": "Single Responsibility"}
            ]
        },
        {
            ...
            "entities": ["authentication", "identity verification", "authorization", "permission verification"],
            "relations": [
                {"subject": "authentication", "predicate": "performs", "object": "identity verification"},
                {"subject": "authorization", "predicate": "determines", "object": "permission verification"}
            ]
        },
        {
            ...
            "entities": ["microservices architecture", "applications", "services", "APIs", "deployment"],
            "relations": [
                {"subject": "microservices architecture", "predicate": "decomposes", "object": "applications"}
            ]
        },
        {
            ...
            "entities": ["reverse proxy", "clients", "servers", "load balancing", "caching", "SSL termination"],
            "relations": [
        ...
        },
        {
            ...
            "relations": [
                {"subject": "horizontal scaling", "predicate": "provides", "object": "fault tolerance"}
            ]
        },
    ]
...
def validate_training_dataset(dataset_path: Path) -> bool:
    ...
    try:
        ...
        if len(samples) < 10:
            raise ValueError(f"Training dataset must contain at least 10 samples (found {len(samples)})")
